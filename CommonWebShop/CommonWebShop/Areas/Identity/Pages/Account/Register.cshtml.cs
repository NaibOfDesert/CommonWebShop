...
namespace CommonWebShop.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [ValidateNever] 
            public IEnumerable<SelectListItem> ComapnyList { get; set; }
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new()
            {
                ...
                ComapnyList = _unitOfWork.company.GetAll().Select(c => new SelectListItem
                {
                    Text = c.Name,
                    Value = c.Id.ToString()
                })
