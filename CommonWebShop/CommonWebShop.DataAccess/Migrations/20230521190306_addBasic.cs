...
{
    /// <inheritdoc />
    public partial class addBasic : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Companies",
                columns: new[] { "Id", "City", "Name", "PostalCode", "State", "StreetAdress" },
                values: new object[,]
                {
                    { 1, "Tokyo", "Tusko", "90-9101", "Tokyo", "Toriyama 3" },
                    { 2, "Nagoya", "Tokono", "90-9101", "Nagoya", "Tetsumo 5" }
                });
